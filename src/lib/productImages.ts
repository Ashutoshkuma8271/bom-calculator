...
export const AKIRA_PRODUCT_IMAGES: PresetProductImage[] = [
  ...
  },
  {
    ...
    category: 'Kebabs & Grills',
    url: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?auto=format&fit=crop&w=900&q=80',
  ...
  },
  {
    ...
    category: 'Patties & Snacks',
    url: 'https://images.unsplash.com/photo-1562967914-608f82629710?auto=format&fit=crop&w=900&q=80',
  ...
  },
  {
    ...
    url: 'https://images.unsplash.com/photo-1585325701165-351af916e581?auto=format&fit=crop&w=900&q=80',
...
export const MATERIAL_IMAGES: Record<string, string> = {
  ...
  'mutton': 'https://images.unsplash.com/photo-1588168333986-5078d3ae3976?auto=format&fit=crop&w=600&q=80',
  ...
  'spice': 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=600&q=80',
  'panko': 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=600&q=80',
  'packaging': 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&w=600&q=80',
  'ice': 'https://images.unsplash.com/photo-1584727638096-042c45049ebe?auto=format&fit=crop&w=600&q=80',
  'box': 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&fit=crop&w=600&q=80',
